...
#acqdivHope=(list(acqdivCorpusReader.iterator()))
#print(acqdivHope)


##print(AcqdivReader.islice(acqdivCorpusReader, 4))

#acqdivhope1=(acqdivHope[:4])
...
for epoch in range(10000):
  ...
  # training_data = AcqdivReaderPartition(acqdivHope1, "train").reshuffledIterator()
   print("Got data")
   print(training_data)
   training_chars = prepareDatasetChunks(training_data, train=True)
   #print(training_chars)
...
with open (CHECKPOINT_HOME + "/results.txt", 'a') as f:
	if devLosses[-1] > devLosses[-2]:
		print(args, (epoch-1), devLosses[-2], file=f)
	else:
		print(args, epoch, devLosses[-1], file=f)
