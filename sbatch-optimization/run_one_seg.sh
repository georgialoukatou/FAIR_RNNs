...
lm_acqdiv="python /scratch2/gloukatou/fair_project/char-lm-code-master/acqdiv_split/detectBoundariesUnit_Hidden_ExtractPattern_NoWhitespace_Classifier_RealText.py"
