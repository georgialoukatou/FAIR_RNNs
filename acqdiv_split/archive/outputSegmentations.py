...
with open("/scratch2/gloukatou/fair_project/checkpoint/segmentation-predictions/"+args.language+"-table.txt", "r") as inFile:
...
stringPredicted = ""
stringReal = ""
with open("/scratch2/gloukatou/fair_project/checkpoint/segmentation-predictions/"+args.language+"-predicted.txt", "w") as outPredicted:
  with open("/scratch2/gloukatou/fair_project/checkpoint/segmentation-predictions/"+args.language+"-real.txt", "w") as outReal:
