...
class AcqdivReader():
   def __init__(self, split, language):
      ...
      self.UTTERANCE_COLNAME = {"Cree":"segmented.utterance","Turkish":"segmented.utterance", "Inuktitut":"segmented.utterance", "Japanese" : "segmented.utterance", "Chintang" : "segmented.utterance", "Indonesian" : "segmented.utterance", "Yucatec" : "segmented.utterance", "Sesotho" : "segmented.utterance", "Russian" : "segmented.utterance"}[self.language]
...
#acqdivCorpusReaderdev = AcqdivReader("dev", "Sesotho").reshuffledIterator(blankBeforeEOS=False)

#training_data = AcqdivReaderPartition(acqdivCorpusReaderdev).reshuffledIterator()
...
#acqdivCorpusReader = AcqdivReader("train", "Sesotho")
...
#AcqdivReaderPartition(AcqdivReader("train", "Sesotho"))
#print(list(AcqdivReaderPartition))

#acqdivCorpusReadertrain = AcqdivReader("train", "Japanese")
