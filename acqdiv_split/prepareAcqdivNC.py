...
basePath = "/scratch2/gloukatou/fair_project/acqdiv-database-master/tsv/acqdiv_final_dataNC/chintang/"
basePathOut = "/scratch2/gloukatou/fair_project/acqdiv-database-master/tsv/acqdiv_final_dataNC/chintang/"
...
def find_child_lines(speakers_file):
        ...
        for line_ in speakers_file:
                if "Target_Child" in line_ or "Child" in line_:
                        column=line_.split("\t")
