...
#if args.language == "Chintang":
 # neuron = [405]
#elif args.language== "Inuktitut":
#  neuron = [9]
...
with open("/scratch2/gloukatou/fair_project/checkpoint/segmentation-predictions/"+args.language+"-table.txt", "w") as outFileTable:
